...
pub fn register(vm: &mut crate::VM) {
    ...
    let baca_func = crate::value::FungsiBawaanVM {
        ...
        func: Arc::new(
            |ctx: &mut dyn VmContext, args: Vec<Value>| -> Result<Value, String> {
                if args.len() != 1 {
                ...
                for (i, baris) in hasil_baris.iter().enumerate() {
                    ...
                    if b_upper.contains("LAHIR") || b_upper.contains("LHR") {
                        ...
                        if parts.len() >= 2 {
                            ...
                            if angka_tgl.len() >= 8 {
                                ...
                                let tempat = text_lahir
                                    .replace(parts.last().unwrap_or(&""), "")
                                    .trim()
                                    .to_string();
                                tempat_lahir = tempat;
                            }
                    ...
                    if b_upper.contains("LAKI")
                        || b_upper.contains("PEREMPUAN")
                        || b_upper.contains("KELAMIN")
                    {
                    ...
                    if b_upper.contains("AGAMA") {
                        let agama_str = b_upper
                            ...
                            .trim()
                            .to_string();
                        if agama_str.contains("ISAM") || agama_str.contains("ISLAM") {
                            agama = "ISLAM".to_string();
                        } else if agama_str.contains("KRIS") {
                            agama = "KRISTEN".to_string();
                        } else if agama_str.contains("KAT") {
                            agama = "KATOLIK".to_string();
                        } else if agama_str.contains("HIN") {
                            agama = "HINDU".to_string();
                        } else if agama_str.contains("BUD") {
                            agama = "BUDDHA".to_string();
                        } else if agama_str.contains("KHON") {
                            agama = "KHONGHUCU".to_string();
                        }
                    }

                    if b_upper.contains("KAWIN") || b_upper.contains("STATUS") {
                        if b_upper.contains("BELUM") {
                            status_perkawinan = "BELUM KAWIN".to_string();
                        } else if b_upper.contains("CERAI MATI") {
                            status_perkawinan = "CERAI MATI".to_string();
                        } else if b_upper.contains("CERAI") {
                            status_perkawinan = "CERAI HIDUP".to_string();
                        } else {
                    ...
                    if b_upper.contains("KEWARGANEGARAAN")
                        || b_upper.contains("WNI")
                        || b_upper.contains("WNA")
                    {
                ...
                let dict_alamat_ptr = ctx
                    .get_heap_mut()
                    .alloc(crate::heap::HeapData::Kamus(dict_alamat));
                ...
                dict.insert(
                    "status_perkawinan".to_string(),
                    make_str!(status_perkawinan),
                );
